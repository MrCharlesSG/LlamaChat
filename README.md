...
If you clone the proyect, you won't be able to run it directly. Instead you need to set the Github client key and the secret key. Also you will need to set the weather key.
